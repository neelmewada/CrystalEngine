...
set(TARGET_WITH_NAMESPACE "ThirdParty::rapidyaml")
if (TARGET ${TARGET_WITH_NAMESPACE})
    return()
endif()

set(PACKAGE_NAME "rapidyaml")
set(PACKAGE_VERISON "0.5.0")
...
set(${LIB_NAME}_INCLUDE_DIR ${${LIB_NAME}_BASE_DIR}/${PACKAGE_NAME}/src ${${LIB_NAME}_BASE_DIR}/${PACKAGE_NAME}/ext/c4core/src)
...
if (${PAL_PLATFORM_NAME} STREQUAL "Linux" OR ${PAL_PLATFORM_NAME} STREQUAL "Mac")
    set(${LIB_NAME}_STATIC_LIBRARY_DEBUG   ${${LIB_NAME}_LIBS_DIR}/Debug/lib${LIB_NAME}.a ${${LIB_NAME}_LIBS_DIR}/Debug/libc4core.a)
    set(${LIB_NAME}_STATIC_LIBRARY_DEV     ${${LIB_NAME}_LIBS_DIR}/Development/lib${LIB_NAME}.a ${${LIB_NAME}_LIBS_DIR}/Development/libc4core.a)
    set(${LIB_NAME}_STATIC_LIBRARY_RELEASE ${${LIB_NAME}_LIBS_DIR}/Release/lib${LIB_NAME}.a ${${LIB_NAME}_LIBS_DIR}/Release/libc4core.a)
elseif (${PAL_PLATFORM_NAME} STREQUAL "Windows")
    set(${LIB_NAME}_STATIC_LIBRARY_DEBUG   ${${LIB_NAME}_LIBS_DIR}/Debug/${LIB_NAME}.lib ${${LIB_NAME}_LIBS_DIR}/Debug/c4core.lib)
    set(${LIB_NAME}_STATIC_LIBRARY_DEV     ${${LIB_NAME}_LIBS_DIR}/Development/${LIB_NAME}.lib ${${LIB_NAME}_LIBS_DIR}/Development/c4core.lib)
    set(${LIB_NAME}_STATIC_LIBRARY_RELEASE ${${LIB_NAME}_LIBS_DIR}/Release/${LIB_NAME}.lib ${${LIB_NAME}_LIBS_DIR}/Release/c4core.lib)
else()
