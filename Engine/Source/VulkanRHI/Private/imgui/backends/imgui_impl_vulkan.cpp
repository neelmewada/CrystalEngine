...
VkRenderPass gPersistentRenderPass = nullptr;
...
void ImGui_ImplVulkanH_CreateWindowSwapChain(VkPhysicalDevice physical_device, VkDevice device, ImGui_ImplVulkanH_Window* wd, const VkAllocationCallbacks* allocator, int w, int h, uint32_t min_image_count)
{
    ...
    wd->ImageCount = 0;
    if (wd->RenderPass && wd->RenderPass != gPersistentRenderPass)
    ...
    if (gPersistentRenderPass == nullptr)
    {
    ...
    {
        wd->RenderPass = gPersistentRenderPass;
    }
...
void ImGui_ImplVulkanH_DestroyWindow(VkInstance instance, VkDevice device, ImGui_ImplVulkanH_Window* wd, const VkAllocationCallbacks* allocator)
{
    ...
    wd->FrameSemaphores = nullptr;
    vkDestroyPipeline(device, wd->Pipeline, allocator);
    if (wd->RenderPass != gPersistentRenderPass)
        vkDestroyRenderPass(device, wd->RenderPass, allocator);
...
static void ImGui_ImplVulkan_RenderWindow(ImGuiViewport* viewport, void*)
{
    ...
    ImGui_ImplVulkanH_FrameSemaphores* fsd = &wd->FrameSemaphores[wd->SemaphoreIndex];
    {
        ...
        }
        {
            ...
            info.clearValueCount = 1;//(viewport->Flags & ImGuiViewportFlags_NoRendererClear) ? 0 : 1;
            info.pClearValues = &wd->ClearValue;//(viewport->Flags & ImGuiViewportFlags_NoRendererClear) ? nullptr : &wd->ClearValue;
