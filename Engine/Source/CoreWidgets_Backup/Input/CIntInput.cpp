...
namespace CE::Widgets
{
	...
	void CIntInput::OnDrawGUI()
	{
		...
		bool ret = GUI::DragScalar(id, GUI::DataType::S64, &value, 1.0f, hasLimits ? &min : nullptr, hasLimits ? &max : nullptr, "%i", preferredSize,
	...
	void CIntInput::HandleEvent(CEvent* event)
	{
