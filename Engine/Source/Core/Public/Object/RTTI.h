...
CE_RTTI_POD(CE, s8,  TYPEID(s16), TYPEID(s32), TYPEID(s64), TYPEID(u8), TYPEID(u16), TYPEID(u32), TYPEID(u64), TYPEID(f32), TYPEID(f64))
CE_RTTI_POD(CE, s16, TYPEID(s8),  TYPEID(s32), TYPEID(s64), TYPEID(u8), TYPEID(u16), TYPEID(u32), TYPEID(u64), TYPEID(f32), TYPEID(f64))
CE_RTTI_POD(CE, s32, TYPEID(s8),  TYPEID(s16), TYPEID(s64), TYPEID(u8), TYPEID(u16), TYPEID(u32), TYPEID(u64), TYPEID(f32), TYPEID(f64))
CE_RTTI_POD(CE, s64, TYPEID(s8),  TYPEID(s16), TYPEID(s32), TYPEID(u8), TYPEID(u16), TYPEID(u32), TYPEID(u64), TYPEID(f32), TYPEID(f64))

CE_RTTI_POD(CE, u8,  TYPEID(s8), TYPEID(s16), TYPEID(s32), TYPEID(s64), TYPEID(u16), TYPEID(u32), TYPEID(u64), TYPEID(f32), TYPEID(f64))
CE_RTTI_POD(CE, u16, TYPEID(s8), TYPEID(s16), TYPEID(s32), TYPEID(s64), TYPEID(u8),  TYPEID(u32), TYPEID(u64), TYPEID(f32), TYPEID(f64))
CE_RTTI_POD(CE, u32, TYPEID(s8), TYPEID(s16), TYPEID(s32), TYPEID(s64), TYPEID(u8),  TYPEID(u16), TYPEID(u64), TYPEID(f32), TYPEID(f64))
CE_RTTI_POD(CE, u64, TYPEID(s8), TYPEID(s16), TYPEID(s32), TYPEID(s64), TYPEID(u8),  TYPEID(u16), TYPEID(u32), TYPEID(f32), TYPEID(f64))
