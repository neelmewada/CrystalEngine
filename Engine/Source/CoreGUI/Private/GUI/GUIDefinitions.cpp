...
namespace CE::GUI
{
    ...
    Style::Style()
	{
        ...
        windowMenuButtonPosition = GUI::Dir_Left;    // Position of the collapsing/docking button in the title bar (left/right). Defaults to ImGuiDir_Left.
        ...
        colorButtonPosition = GUI::Dir_Right;   // Side of the color button in the ColorEdit4 widget (left/right). Defaults to ImGuiDir_Right.
