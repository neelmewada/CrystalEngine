...
CompileShader() {
    ...
    ${DxCompiler} -spirv -E VertMain -T vs_6_0 -Fo ${VertOut} ${FileName} -fspv-reflect #-fvk-use-dx-layout
    ${DxCompiler} -spirv -E FragMain -T ps_6_0 -Fo ${FragOut} ${FileName} -fspv-reflect #-fvk-use-dx-layout
